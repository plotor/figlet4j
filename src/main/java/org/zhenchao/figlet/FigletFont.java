...
public class FigletFont {
    ...
    public FigletFont(FontType fontType) throws IOException {
        this(FigletFont.class.getClassLoader().getResourceAsStream(fontType.filename()));
    }
    ...
    public static String convertOneLine(String message) throws IOException {
        return convertOneLine(FigletFont.class.getClassLoader().getResourceAsStream(FontType.STANDARD.filename()), message);
    }
